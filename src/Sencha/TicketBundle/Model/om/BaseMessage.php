...
abstract class BaseMessage extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Sencha\\TicketBundle\\Model\\MessagePeer';
    ...
    public function setPriority($v)
    {
        ...
        if ($this->priority !== $v) {
            $this->priority = $v;
            $this->modifiedColumns[] = MessagePeer::PRIORITY;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->header_mail = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
            $this->body = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
            $this->ip_address = ($row[$startcol + 7] !== null) ? (string) $row[$startcol + 7] : null;
            $this->status = ($row[$startcol + 8] !== null) ? (string) $row[$startcol + 8] : null;
            $this->priority = ($row[$startcol + 9] !== null) ? (string) $row[$startcol + 9] : null;
            $this->source = ($row[$startcol + 10] !== null) ? (string) $row[$startcol + 10] : null;
            $this->overdue_date = ($row[$startcol + 11] !== null) ? (string) $row[$startcol + 11] : null;
            $this->last_response_date = ($row[$startcol + 12] !== null) ? (string) $row[$startcol + 12] : null;
            $this->creation_date = ($row[$startcol + 13] !== null) ? (string) $row[$startcol + 13] : null;
            $this->modification_date = ($row[$startcol + 14] !== null) ? (string) $row[$startcol + 14] : null;
            $this->resetModified();
            ...
            return $startcol + 15; // 15 = MessagePeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(MessagePeer::PRIORITY)) {
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        $result = array(
            ...
            $keys[5] => $this->getHeaderMail(),
            $keys[6] => $this->getBody(),
            $keys[7] => $this->getIpAddress(),
            $keys[8] => $this->getStatus(),
            $keys[9] => $this->getPriority(),
            $keys[10] => $this->getSource(),
            $keys[11] => $this->getOverdueDate(),
            $keys[12] => $this->getLastResponseDate(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[5], $arr)) $this->setHeaderMail($arr[$keys[5]]);
        ...
        if (array_key_exists($keys[10], $arr)) $this->setSource($arr[$keys[10]]);
        if (array_key_exists($keys[11], $arr)) $this->setOverdueDate($arr[$keys[11]]);
        if (array_key_exists($keys[12], $arr)) $this->setLastResponseDate($arr[$keys[12]]);
        if (array_key_exists($keys[13], $arr)) $this->setCreationDate($arr[$keys[13]]);
        if (array_key_exists($keys[14], $arr)) $this->setModificationDate($arr[$keys[14]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(MessagePeer::PRIORITY)) $criteria->add(MessagePeer::PRIORITY, $this->priority);
